                ...
                <div class="col-12">
                    <div class="card card-info mt-3">
                        ...
                        <form method="POST" action="{{ route('department-store') }}">
                            {{ csrf_field() }}
                            <input type="hidden" name="department_id" value="{{ $department_by_id->id }}">
